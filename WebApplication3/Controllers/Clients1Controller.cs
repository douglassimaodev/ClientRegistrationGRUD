...
namespace WebApplication3.Controllers
{
    public class Clients1Controller : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Email,CompanyName,DateOfBirthday")] Client client)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Email,CompanyName,DateOfBirthday")] Client client)
        {
            if (id != client.Id)
            {
                return NotFound();
